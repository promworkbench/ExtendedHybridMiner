 ...
 */
public class HybridDirectedUncertainGraphEdge extends HybridDirectedGraphEdge {

	NumberFormat nf=null;
    /*public HybridDirectedUncertainGraphEdge(HybridDirectedGraphNode source, HybridDirectedGraphNode target, double value1, double value2) {
        super(source, target);
		...
		String[] labels = {nf.format(value1).replace(",",""),nf.format(value2).replace(",","")};
    ...
    public HybridDirectedUncertainGraphEdge(HybridDirectedGraphNode source, HybridDirectedGraphNode target) {
        super(source, target);
        String[] lab={"          ","        "};
    ...
    public void setLabel(double value1)
    {
    	...
    	//getAttributeMap().remove(AttributeMap.EXTRALABELS);
    	getAttributeMap().put(AttributeMap.EXTRALABELS, lab);
    }
