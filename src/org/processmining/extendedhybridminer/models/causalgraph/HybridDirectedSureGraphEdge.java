 ...
 */
public class HybridDirectedSureGraphEdge extends HybridDirectedGraphEdge {

	NumberFormat nf=null;
    /*public HybridDirectedSureGraphEdge(HybridDirectedGraphNode source, HybridDirectedGraphNode target, double value1, double value2) {
        super(source, target); 
		...
		getAttributeMap().put(AttributeMap.SIZE,10000);
		getAttributeMap().put(AttributeMap.AUTOSIZE,true);
		getAttributeMap().put(AttributeMap.LABELHORIZONTALALIGNMENT,SwingConstants.LEFT);
    ...
    public HybridDirectedSureGraphEdge(HybridDirectedGraphNode source, HybridDirectedGraphNode target) {
        super(source, target);
        String[] lab={"          ","        "};
        getAttributeMap().put(AttributeMap.EXTRALABELS,lab);
        getAttributeMap().put(AttributeMap.LABEL, " ");
