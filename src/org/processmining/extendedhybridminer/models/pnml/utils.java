...
public class utils {
	...
	public static void importHybridPetrinetFromStream(PluginContext context, InputStream input, ExtendedHybridPetrinet net) throws Exception {
	...
	public static void exportHybridPetrinetToFile(PluginContext context, File file, ExtendedHybridPetrinet net) throws IOException {
	...
	private static void convertNetToPnml(ExtendedHybridPetrinet net, HybridPnml pnml, GraphLayoutConnection layout,
	...
	private static PnmlPage createPnmlPage(ExtendedHybridPetrinet net, Marking iMarking, Map<Pair<AbstractGraphElement, ExpandableSubNet>, String> map,
