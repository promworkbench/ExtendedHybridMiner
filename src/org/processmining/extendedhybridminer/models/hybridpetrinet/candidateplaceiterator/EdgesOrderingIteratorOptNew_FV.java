...
public class EdgesOrderingIteratorOptNew_FV<N extends AbstractDirectedGraphNode, E extends AbstractDirectedGraphEdge> extends CandidatePlaceIterator<N>{
	...
	public EdgesOrderingIteratorOptNew_FV(EdgesOrderingCompatibleSelStrategy<N> selectionStrategy, Set<E> edges) {
	...
	public boolean hasNext() {
		...
		if (currentK<maxInputPlusOutput-1) {
			currentK++;
